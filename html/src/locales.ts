...
const zh: Record<string, string> = {
  ...
  exportProjectKJS: '导出项目 (.kjsw)',
  importProject: '导入项目 (.tlbw)',
  importProjectKJS: '导入项目 (.kjsw)',
  settings: '设置',
  language: '语言',
  help: '帮助手册',
  about: '关于',
  aboutDesc: '专为 TACZ (Timeless and Classics Zero) 设计的积木编程编辑器',
  kjsAboutDesc: '专为 KubeJS / TaCZJS 设计的积木编程编辑器',
  ...
  confirmKJS: '切换到TaCZJS模式将清空工作区，确定继续？',
  confirmBackTACZ: '切回TACZ模式将清空TaCZJS工作区，确定继续？',
}
...
const en: Record<string, string> = {
  ...
  exportProjectKJS: 'Export Project (.kjsw)',
  importProject: 'Import Project (.tlbw)',
  importProjectKJS: 'Import Project (.kjsw)',
  settings: 'Settings',
  language: 'Language',
  help: 'Help Manual',
  about: 'About',
  aboutDesc: 'Block programming editor for TACZ (Timeless and Classics Zero)',
  kjsAboutDesc: 'Block programming editor for KubeJS / TaCZJS',
  ...
  confirmKJS: 'Switch to TaCZJS mode will clear workspace. Continue?',
  confirmBackTACZ: 'Switch back to TACZ will clear TaCZJS workspace. Continue?',
}
